...
async def get_category_current_progress(
    ...
    svc_level: LevelService = Depends(get_level_service_admin),
):
    ...
    next_level = await svc_level.get_next_available_level(
        category_id=category_id, level_id=cpi.level_id
    )

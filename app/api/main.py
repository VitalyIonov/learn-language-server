...
client_router.include_router(client_routes.levels.router)
...
admin_router.include_router(admin_routes.text_definitions.router)
admin_router.include_router(admin_routes.image_definitions.router)
admin_router.include_router(admin_routes.images.router)
admin_router.include_router(admin_routes.question_types.router)
